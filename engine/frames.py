...
class VolunteerFrame:
    ...
    def __init__(self, sex=Sexo.MASCULINO, edad=None, enfermedad_patologica=None, controlada=None, examen_fisico=None, auscultacion_respiratoria=None,
    ...
    def es(self, volunteer_data):
        return ((not self.edad or self.edad == volunteer_data["edad"]) and \
                ((not self.enfermedad_grave) or self.enfermedad_grave == volunteer_data["enfermedad_grave"]) and \
...
class WomanVolunteerFrame(VolunteerFrame):
    ...
    def __init__(self, sex=Sexo.FEMENINO, edad=None, enfermedad_patologica=None, controlada=None, examen_fisico=None, auscultacion_respiratoria=None,
        ...
        super().__init__(sex, edad, enfermedad_patologica, controlada, examen_fisico, auscultacion_respiratoria,
    ...
    def es(self, volunteer_data):
        return ((Sexo.FEMENINO == volunteer_data["sexo"])
                and ((not self.embarazo_actual) or (self.embarazo_actual == volunteer_data["embarazo_actual"])) \
